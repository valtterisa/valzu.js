...
A modern React application built with Valzu.js, featuring server-side rendering powered by Vite for optimal SEO and performance.
...
Use the `Head` component from `valzu-core` to manage meta tags:
...
- [Valzu.js Documentation](https://github.com/valtterisa/valzu.js)
