...
export function useServer(options) {
  ...
  const pagesDir = (
    options === null || options === void 0 ? void 0 : options.pagesDir
  )
    ? path.resolve(options.pagesDir)
    : path.resolve(cwd, "src/pages");
  const publicDir = (
    options === null || options === void 0 ? void 0 : options.publicDir
  )
  ...
  const port =
    (options === null || options === void 0 ? void 0 : options.port) ||
