...
export default function Home() {
  return (
    <>
      <Head
        title="Welcome to Landr.js"
        description="Build fast, SEO-friendly landing pages with Landr.js - a modern React SSR framework powered by Vite"
        keywords="landr, react, ssr, vite, landing page, seo"
        ogTitle="Welcome to Landr.js"
        ogDescription="Build fast, SEO-friendly landing pages with Landr.js"
        ogType="website"
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-2xl rounded-lg bg-card text-card-foreground shadow-lg p-8 border border-border">
          ...
          <section className="flex gap-4 flex-wrap justify-center mt-8">
            ...
            <a
              href="https://github.com/valtterisa/landr.js"
              target="_blank"
